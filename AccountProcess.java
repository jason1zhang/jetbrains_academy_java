 ...
 * See the full declarations of these classes in the code template. Do not be afraid of 
 * the static keyword. It's not important now.
 *
 * In the main method, create an instance of the Account class and pass it to the process 
 * method by calling process(account). This method is already defined.
 *
